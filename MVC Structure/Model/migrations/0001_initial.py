# Generated by Django 3.1.4 on 2022-04-30 09:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderitems', models.ManyToManyField(to='Model.Appointment')),
        ...
        migrations.AddField(
            ...
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cart', to='Model.doctor'),
        ),
        migrations.AddField(
            model_name='appointment',
            name='user',
